// AquaSense IoT — Tipos exatos dos payloads publicados pelo ESP32 (firmware v3.1, Arduino).
// Fonte: tópico aquasense-ibmec-pt/dados (consolidado) e tópicos individuais
// aquasense-ibmec-pt/* (piscina/*, coletor/*, sistema/*, controle/*, dosagem/*).
